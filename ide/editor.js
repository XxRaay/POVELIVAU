...
const KEYWORDS = [
  ...
  "Повелеваю: Явить окно и наречь",
  "Повелеваю: Внять глас народа",
  "Повелеваю: Наречь окно",
  "титулом",
  "Повелеваю: Установить окну",
  "пределы",
  "Явить надпись на",
  "с текстом",
  "Явить кнопку на",
  "с надписью",
  "и при нажатии призвать умение",
  "Явить поле ввода на",
  "Явить чертог на",
  "Повелеваю: Разместить виджет",
  "Повелеваю: Сокрыть виджет",
  "значение поля",
...
const COMPLETIONS = [
  ...
  { text: "Вещаю построчно:",                     desc: "print() по строкам для дружины" },
  ...
  { text: "из земель дальних призвать весть по адресу", desc: "HTTP GET (requests.get)" },
  { text: "из земель дальних послать весть по адресу",  desc: "HTTP POST (requests.post)" },
  { text: "Повелеваю: Обозреть всё в пределе текущем и наречь", desc: "os.listdir() — обозреть владения" },
  { text: "Повелеваю: Узнать имя земли текущей и наречь",       desc: "os.getcwd() — путь текущей земли" },
  { text: "Повелеваю: Сменить землю на",                        desc: "os.chdir(path) — сменить землю" },
  { text: "Повелеваю: Возвести чертог новый именем",            desc: "os.mkdir(path) — возвести чертог" },
  { text: "Повелеваю: Предать забвению чертог",                 desc: "shutil.rmtree(path) — стереть чертог" },
  { text: "Повелеваю: Изгнать из земель свиток",                desc: "os.remove(path) — изгнать свиток" },
  { text: "Повелеваю: Переименовать грамоту",                   desc: "os.rename(src, dst) — переименовать грамоту" },
  { text: "в землях есть",                                     desc: "os.path.exists(path) — проверить, что путь есть в землях" },
  { text: "Повелеваю: Сотворить свиток",                        desc: "open(path, 'w') — создать пустой/очистить свиток" },
  { text: "Повелеваю: Вписать в свиток",                        desc: "append в txt‑свиток (файл)" },
  { text: "прочитать свиток",                                  desc: "read().splitlines() — прочитать txt в дружину строк" },
  { text: "Повелеваю: Вычеркнуть из свитка",                    desc: "удалить строку из txt по номеру (1 = первая)" },
  { text: "строку под номером",                                desc: "часть команды вычёркивания строки" },
  { text: "Повелеваю: Явить окно и наречь",                     desc: "Tk() — создать окно" },
  { text: "Повелеваю: Внять глас народа",                       desc: "mainloop() — показать окно" },
  { text: "Повелеваю: Наречь окно",                             desc: "title() — заголовок окна" },
  { text: "титулом",                                            desc: "часть команды заголовка окна" },
  { text: "Повелеваю: Установить окну",                         desc: "geometry() — размер/позиция окна" },
  { text: "пределы",                                            desc: "часть команды geometry()" },
  { text: "Явить надпись на",                                   desc: "Label(parent, text=...)" },
  { text: "с текстом",                                          desc: "часть команды создания надписи" },
  { text: "Явить кнопку на",                                    desc: "Button(parent, text=...)" },
  { text: "с надписью",                                         desc: "часть команды создания кнопки" },
  { text: "и при нажатии призвать умение",                      desc: "Button(command=умение)" },
  { text: "Явить поле ввода на",                                desc: "Entry(parent)" },
  { text: "Явить чертог на",                                    desc: "Frame(parent)" },
  { text: "Повелеваю: Разместить виджет",                       desc: "pack() — разместить виджет" },
  { text: "Повелеваю: Сокрыть виджет",                          desc: "destroy() — уничтожить виджет" },
  { text: "значение поля",                                      desc: "Entry.get() — прочитать поле ввода" },
...
Повелеваю: Начать выполнение!`,
  ...
  gui: {
    icon: "🪟", label: "Окно и виджеты (Tkinter)",
    code:
